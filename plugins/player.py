...
async def notforu(_, m: Message):
    await _.send_cached_media(chat_id=m.chat.id, file_id="CAADBQADEgQAAtMJyFVJOe6-VqYVzAI", caption="You Are Not Authorized", reply_markup=InlineKeyboardMarkup([[InlineKeyboardButton('⚡️Join Here', url='https://t.me/TamilMovies_Request')]]))
...
async def not_chat(_, m: Message):
    buttons = [
        [
            ...
            InlineKeyboardButton('🧩 Join Here', url='https://t.me/TamilMovies_Request'),
        ]
        ]
